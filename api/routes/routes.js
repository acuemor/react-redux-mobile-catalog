var appRouter = function (app) {
    ...
    app.get("/phones", function (req, res) {
        var data = ([{
            ...
            description: 'Con el Samsung Galaxy S8 podrás disfrutar de todo el contenido gracias a su pantalla infinita de 5,8" y su diseño inmersivo (pantalla sin bordes).',
            ...
            inStock: true,
            text: 'Apple iPhone 6',
            description: 'Incluye una pantalla Retina HD de 4,7 pulgadas. Chip A8 con arquitectura de 64 bits. Nueva cámara iSight de 8 megapíxeles con Focus Pixels.',
